          ...
          <div className="relative bg-gradient-to-br from-[#3d2817] via-amber-900 to-[#2d1f11] rounded-3xl shadow-2xl overflow-hidden animate-pulse-glow">
            ...
            <div className="relative bg-gradient-to-r from-amber-400 via-orange-400 to-amber-400 py-3 text-center overflow-hidden">
              ...
              <p className="relative text-[#3d2817] font-bold text-lg">
                🔥 OFERTA EXCLUSIVA - SOLO HASTA EL 31 DE DICIEMBRE 🔥
              </p>
            </div>
                ...
                <div>
                  <div className="mb-8">
                    ...
                    <p className="text-xl text-amber-200 mb-8">
                      ¡Tu momento de relajación al mejor precio del año!
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Link href="/servicios" className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white px-10 py-5 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-110 border-2 border-white/50 hover:border-white">
                      Ver Detalles
          ...
          <div className="relative bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 text-center py-16 px-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/reservas" className="group relative inline-flex items-center gap-3 bg-white hover:bg-stone-100 text-green-600 px-12 py-5 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-110 shadow-2xl">
                ...
                <Link href="/servicios" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white px-12 py-5 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-110 border-2 border-white/50 hover:border-white">
                  Ver Servicios
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                  </svg>
